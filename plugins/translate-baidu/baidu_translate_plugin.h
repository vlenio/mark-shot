 ...
 * 百度翻译 provider 插件。
 *
 * 插件读取 translation.baidu 配置与环境变量，使用开放平台通用翻译接口翻译 OCR 分段，
 * 多段文本在单次请求中用换行连接，译文按请求顺序回填。
 */
class BaiduTranslatePlugin final : public QObject, public markshot::plugin::TranslateProviderPlugin {
    Q_OBJECT
